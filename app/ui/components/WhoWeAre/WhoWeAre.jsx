    ...
    <div className={styles.container}>
        ...
        <div className={styles.wrapper}>
            ...
            <div className={styles.content}>
                ...
                <div className={styles.right}>
                    <p className={styles.text}>
                      <b className={`${titan.className}`}>Gabriela Rojas</b>, CEO & Founder de <b className={`${titan.className}`}>«Dulce almendra»</b> una empresa comprometida con brindar atención de calidad a los 
                      más pequeños, Gabriela se destaca por su sensibilidad, profesionalismo y atención al detalle
                    </p>
                    <p className={styles.text}>
                        <b className={`${titan.className}`}>Dulce Almendra</b> nace a partir de la necesidad de complementar el trabajo de las maternidades en sus primeros pasos.
                        ...
                        Nuestra misión nace a partir de su creadora Ana Gabriela Rojas, fundadora de Dulce Almendra, quien propone estrategias de 
            ...
            <div className={styles.bottom}>
              ...
              <p className={styles.text}>
              <b className={`${titan.className}`}>Dulce Almendra</b> está formada por un equipo de profesionales especializadas en primera infancia. Acompañando a maternar y 
